...
void init_kernel_memory() {
    ...
    // in addition, the kernel can access [1GiB,4GiB) of physical memory;
    // this includes important memory-mapped I/O devices
...
struct ramimage {
    ...
    { "quotes", _binary_obj_p_quotes_start, _binary_obj_p_quotes_end }
};
